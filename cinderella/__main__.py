...
----> Contact [Him](https://t.me/pandityuvrajsharma) if i am dead😑.
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands. OM NAMO NARAYAN!",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚜️Help",url="t.me/{}?start=help".format(bot.username))],  
...
def source(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        try:
            ...
            update.effective_message.reply_text("Pandit Ji Jindabaad!.")
        except Unauthorized:
            update.effective_message.reply_text("Pandit Ji Jindabaad!.")
