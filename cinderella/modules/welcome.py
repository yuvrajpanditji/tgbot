...
def new_member(bot: Bot, update: Update):
    ...
    if chatbanned:
        ...
        for new_mem in new_members:
            ...
            elif new_mem.id == 822874617:
                update.effective_message.reply_text("Oh🤴Genos,My Creator/Developer has just joined your group. May Lord Vishnu Bless him!")

            # Make bot greet admins
            elif new_mem.id == bot.id:
                update.effective_message.reply_text("Hey {}, I'm {}! Thank you for adding me to {}" 
                " and be sure to check /help in PM for more commands and tricks! Pandit Ji Jindabaad!".format(user.first_name, bot.first_name, chat_name))
                bot.send_message(
                    MESSAGE_DUMP,
